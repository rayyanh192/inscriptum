...
# Keep in chronological order (week 1 -> week 2 -> week 3)
...
ax1.plot([1, 2, 3], accuracies, marker='o', linewidth=3, markersize=10, color='#2E86AB')
ax1.fill_between([1, 2, 3], accuracies, alpha=0.3, color='#2E86AB')
ax1.set_xlabel('Week (1=earliest, 3=most recent)', fontsize=12)
ax1.set_ylabel('Accuracy (%)', fontsize=12)
ax1.set_title('📈 Accuracy Improvement: 60% → 78%', fontsize=13, fontweight='bold')
ax1.grid(True, alpha=0.3)
ax1.set_ylim(50, 85)
for i, (week, acc) in enumerate(zip([1, 2, 3], accuracies)):
...
ax2.bar([1, 2, 3], rules_counts, color=['#E63946', '#F77F00', '#06A77D'], alpha=0.8, width=0.6)
ax2.set_xlabel('Week (1=earliest, 3=most recent)', fontsize=12)
ax2.set_ylabel('Number of Rules', fontsize=12)
ax2.set_title('🧠 Learned Rules: 3 → 10', fontsize=13, fontweight='bold')
ax2.grid(True, alpha=0.3, axis='y')
for i, (week, count) in enumerate(zip([1, 2, 3], rules_counts)):
...
ax3.set_xlabel('Week (1=earliest, 3=most recent)', fontsize=12)
...
ax4.set_xlabel('Week (1=earliest, 3=most recent)', fontsize=12)
...
for i, (week, correct, total) in enumerate(zip([1, 2, 3], correct_per_week, emails_per_week)):
...
ax.plot([1, 2, 3], accuracies, marker='o', linewidth=4, markersize=15, color='#2E86AB')
ax.fill_between([1, 2, 3], accuracies, alpha=0.2, color='#2E86AB')
ax.set_xlabel('Week (1=earliest, 3=most recent)', fontsize=14)
